...
import { getTime, isAfter, isThisMonth, isToday, startOfMonth, startOfWeek } from "date-fns"
import { ColumnDef, ColumnFiltersColumn, ColumnFiltersState, flexRender, getCoreRowModel, getFilteredRowModel, getPaginationRowModel, getSortedRowModel, Row, SortingState, useReactTable } from "@tanstack/react-table";
...
export const CategoryPageContent = ({ hasEvents: initialHasEvents, category }: CategoryPageContentProps) => {
    ...
    //https://localhost:3000/dashboard/category/page?page=1&limit=30
    ...
    const { data, isFetching } = useQuery({
        ...
        queryFn: async () => {
            const rest = await client.category.getEventsByCategoryName.$get({
                name: category.name,
