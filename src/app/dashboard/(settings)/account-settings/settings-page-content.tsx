    ...
    return (
        <Card className="max-w-xl w-full space-y-4">
            ...
            <p className="mt-2 text-sm/6 text-gray-600">
                ...
                <Link href='https://support.discord.com/hc/en-us/articles/206346498-Where-can-I-find-my-User-Server-Message-ID' className="text-brand-600 hover:text-brand-500">Learn how to obtain it here</Link>
                .
            </p>
